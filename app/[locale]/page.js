    ...
    <main className="pt-16">
      ...
      <section className="bg-primary-container px-6 pt-12 pb-24 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl md:text-6xl font-headline font-bold text-white stenciled-headline leading-none uppercase mb-4">
            {t('hero.headline')}
          </h1>
      ...
      <section className="px-6 py-16">
        <div className="flex justify-between items-end mb-8">
          ...
          <div className="h-[2px] flex-grow mx-4 bg-outline-variant/20 mb-2"></div>
        </div>
